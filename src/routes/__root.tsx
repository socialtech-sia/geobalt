...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "geobalt.lv — Ģeodēzijas aprīkojums un risinājumi" },
      { property: "og:description", content: "Profesionāli GNSS uztvērēji, lauka datori, nivelieri un mērniecības aprīkojums. Pārdošana, noma un serviss Baltijā." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "geobalt.lv — Ģeodēzijas aprīkojums un risinājumi" },
      { name: "twitter:description", content: "Profesionāli GNSS uztvērēji, lauka datori, nivelieri un mērniecības aprīkojums. Pārdošana, noma un serviss Baltijā." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c8d7b09d-38fd-4555-bb04-175a107e208e" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c8d7b09d-38fd-4555-bb04-175a107e208e" },
